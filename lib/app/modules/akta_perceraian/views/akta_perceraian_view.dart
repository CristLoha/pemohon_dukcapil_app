              ...
              Center(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      GetBuilder<AktaPerceraianController>(
                        builder: (c) => c.pickedImageAktaPernikahan != null
                            ? Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      c.pickedImageAktaPernikahan!.name,
                                      style: blackTextStyle.copyWith(),
                                      overflow: TextOverflow.ellipsis,
                                    ),
                                  ),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: GetBuilder<AktaPerceraianController>(
                              builder: (c) {
                                return c.pickedImageAktaPernikahan != null
                                    ? ElevatedButton(
                                        onPressed: () {
                                          Get.dialog(
                                            Container(
              ...
              Center(
                child: Container(
                  ...
                  child: Column(
                    children: [
                      GetBuilder<AktaPerceraianController>(
                        builder: (c) => c.pickedImageSuketPanitera != null
                            ? Row(
                                children: [
                                  Expanded(
                                    child: Text(
                                      c.pickedImageSuketPanitera!.name,
                                      style: blackTextStyle.copyWith(),
                                      overflow: TextOverflow.ellipsis,
                                    ),
                                  ),
                      ...
                      Row(
                        ...
                        children: [
                          Container(
                            ...
                            child: GetBuilder<AktaPerceraianController>(
                              builder: (c) {
                                return c.pickedImageSuketPanitera != null
                                    ? ElevatedButton(
                                        onPressed: () {
                                          Get.dialog(
                                            Container(
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                controller.selectImageSuketPanitera();
                              },
                              child: Text(
                                'Pilih File',
                                style: blackTextStyle.copyWith(
